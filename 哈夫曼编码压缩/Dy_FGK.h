...
/*
 * Abstract:
 *   This article implements dynamic huffman coding compression with FGK algorithm.
 */

#ifndef FGK_AlGORITHM
#define FGK_ALGORITHM
...
public:
    ...
    /* constructor. */
    FGK(const string &file) :filePath(file)
    { 
        tree[root].ch = NYT; 
